...
//    private var currentUrl = "" // 当前URL（校验合法性）
...
//        decor.addView(mask, ViewGroup.LayoutParams(-1, -1))
//        // 把 mask 存到 MASK_TAG，搜完再 removeView
//        decor.setTag(R.id.mask_view_tag, mask)
...
//        // 移除 MASK_TAG
//        val decor = window.decorView as ViewGroup
//        decor.removeView(decor.getTag(R.id.mask_view_tag) as View?)
//
//    }
//
...
//  '//*[@id="root"]/div/div/div[6]/div[1]/text()',
//  document,
//  null,
...
//
//// 获取是否轮到当前玩家
//document.querySelector("#root > div > div > div.mt-2 > div.space-x-4.flex.items-center.justify-center > span").textContent
//
//"""
//
//// 校验 url 合法性
//// https://game.hullqin.cn/jzq