...
class UTTModeSelect : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_uttmode_select)
        // 显示返回箭头（←）
        ...
        // 绑定玩家选择跳转
        val buttonPlayerSelect = findViewById<Chip>(R.id.chipAIvsHuman)
        buttonPlayerSelect.setOnClickListener {
            val utt_player_intent = Intent(this, UTTHumanPlayerSelect::class.java)
