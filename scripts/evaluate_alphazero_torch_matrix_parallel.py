...
try:
    ...
    from alphazero_torch import RULE_VERSION, TorchPolicyValueNetwork, _model_prior
    ...
    from scripts.alphazero_torch import RULE_VERSION, TorchPolicyValueNetwork, _model_prior
